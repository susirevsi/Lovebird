            	...
            	<form class="form-horizontal" name="form1" method="post" action="" enctype="multipart/form-data">
                    ...
                    <?php
						if(isset($_POST['simpan'])){
							mysqli_query($GLOBALS["___mysqli_ston"], "insert into admin (username, password, nama, phone, email) values ('$_POST[username]', '$_POST[password]', '$_POST[nama]', '$_POST[phone]', '$_POST[email]')")
							or die(mysql_error);
