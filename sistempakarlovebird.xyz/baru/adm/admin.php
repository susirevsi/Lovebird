<?php
	...
	$jml_data = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select * from admin"));
	...
	if(isset($_GET['hal'])){
			...
			$s = mysqli_query($GLOBALS["___mysqli_ston"], "select * from admin order by id_user desc limit ".(($hal - 1) * $jml_per_halaman).", $jml_per_halaman");
		
	}else{
		$s = mysqli_query($GLOBALS["___mysqli_ston"], "select * from admin order by id_user desc limit 0, $jml_per_halaman")
