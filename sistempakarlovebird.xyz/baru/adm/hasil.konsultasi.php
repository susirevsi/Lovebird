<?php
	...
	$jml_data = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select * from keterangan"));
	...
	if(isset($_GET['hal'])){
			...
			$s = mysqli_query($GLOBALS["___mysqli_ston"], "select * from keterangan order by id_keterangan desc limit ".(($hal - 1) * $jml_per_halaman).", $jml_per_halaman");
		
	}else{
		$s = mysqli_query($GLOBALS["___mysqli_ston"], "select * from keterangan order by id_keterangan desc limit 0, $jml_per_halaman")
                ...
                <div style="margin-top:10px">
                    ...
                    <tbody>
                        ...
                        <td><font face="Comic Sans MS, cursive" class="text-info text-left"><h5>
							<?php
								$sh = mysqli_query($GLOBALS["___mysqli_ston"], "select * from hasil_konsultasi where konsultasi='$id_konsultasi'");
								
								while($dh = mysqli_fetch_array($sh)){
									$sg = mysqli_query($GLOBALS["___mysqli_ston"], "select * from gejala where id_gejala='$dh[id_gejala]'");
                        ...
                        <td><font face="Comic Sans MS, cursive" class="text-info text-center"><h5>
							<?php
								$sp=mysqli_query($GLOBALS["___mysqli_ston"], "select * from penyakit where kode_penyakit='$kode_penyakit'");
