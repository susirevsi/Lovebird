<?php
	...
	$jml_data = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select * from informasi"));
	...
	if(isset($_GET['hal'])){
			...
			$s = mysqli_query($GLOBALS["___mysqli_ston"], "select * from informasi order by id_informasi desc limit ".(($hal - 1) * $jml_per_halaman).", $jml_per_halaman");
		
	}else{
		$s = mysqli_query($GLOBALS["___mysqli_ston"], "select * from informasi order by id_informasi desc limit 0, $jml_per_halaman")
                    ...
                    <tbody>
                        ...
                        <td>
                        	<font face="Comic Sans MS, cursive" class="text-info text-center"><h5>
                                <a class="tip" href="informasi.update.php?inf=<?php echo $id;?>" data-toggle="tooltip" data-placement="bottom"
                                    title="Edit"><span class="icon-pencil"></span></a>
                                <a class="tip" href="informasi.delete.php?inf=<?php echo $id;?>" data-toggle="tooltip" data-placement="bottom"
