			...
			<div>
                ...
                <div style="margin-top:10px">
                    <table class="table table-condensed table-bordered table-hover">
                        ...
                        <?php
                            $i = 1;
                            $spg = mysqli_query($GLOBALS["___mysqli_ston"], "select * from penyakit_gejala group by kode_penyakit desc");
                            while($dpg = mysqli_fetch_array($spg)){
                                $sp = mysqli_query($GLOBALS["___mysqli_ston"], "select * from penyakit where kode_penyakit='$dpg[kode_penyakit]'");
                        ...
                        <tbody>
                            ...
                            <td><font face="Comic Sans MS, cursive" class="text-info text-left"><h5>
                                <?php
                                    $sg = mysqli_query($GLOBALS["___mysqli_ston"], "select * from penyakit_gejala where kode_penyakit='$dpg[kode_penyakit]'");
                                    
                                    while($dg = mysqli_fetch_array($sg)){
                                        $sp1 = mysqli_query($GLOBALS["___mysqli_ston"], "select * from gejala where id_gejala='$dg[id_gejala]'");
