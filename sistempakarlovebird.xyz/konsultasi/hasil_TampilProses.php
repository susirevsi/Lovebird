                ...
                <div style="margin-top:20px">
                    ...
                    <?php
						...
						while($d1 = mysqli_fetch_array($s1)){
							if($r1>0){
								$sg1 = mysqli_query($GLOBALS["___mysqli_ston"], "select * from gejala where id_gejala='$d1[id_gejala]'") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
						...
						$ssum1 = mysqli_query($GLOBALS["___mysqli_ston"], "select sum(if(a.konsultasi=$konsultasi, a.bobot,0)) as j1
                                                from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P01%')") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
						...
						while($d2 = mysqli_fetch_array($s2)){
							if($r2>0){
								$sg2 = mysqli_query($GLOBALS["___mysqli_ston"], "select * from gejala where id_gejala='$d2[id_gejala]'") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
                        ...
                        $ssum2 = mysqli_query($GLOBALS["___mysqli_ston"], "select sum(if(a.konsultasi=$konsultasi, a.bobot,0)) as j2
                                                from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P02%')") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
						...
						while($d3 = mysqli_fetch_array($s3)){
							if($r3>0){
								$sg3 = mysqli_query($GLOBALS["___mysqli_ston"], "select * from gejala where id_gejala='$d3[id_gejala]'") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
						...
						$ssum3 = mysqli_query($GLOBALS["___mysqli_ston"], "select sum(if(a.konsultasi=$konsultasi, a.bobot,0)) as j3
                                                from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P03%')") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
						...
						while($d4 = mysqli_fetch_array($s4)){
							if($r4>0){
								$sg4 = mysqli_query($GLOBALS["___mysqli_ston"], "select * from gejala where id_gejala='$d4[id_gejala]'") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
                        ...
                        $ssum4 = mysqli_query($GLOBALS["___mysqli_ston"], "select sum(if(a.konsultasi=$konsultasi, a.bobot,0)) as j4
                                                from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P04%')") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
						...
						while($d5 = mysqli_fetch_array($s5)){
							if($r5>0){
								$sg5 = mysqli_query($GLOBALS["___mysqli_ston"], "select * from gejala where id_gejala='$d5[id_gejala]'") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
                        ...
                        $ssum5 = mysqli_query($GLOBALS["___mysqli_ston"], "select sum(if(a.konsultasi=$konsultasi, a.bobot,0)) as j5
                                                from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P05%')") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
						...
						while($d6 = mysqli_fetch_array($s6)){
							if($r6>0){
								$sg6 = mysqli_query($GLOBALS["___mysqli_ston"], "select * from gejala where id_gejala='$d6[id_gejala]'") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
						...
						while($d7 = mysqli_fetch_array($s7)){
							if($r7>0){
								$sg7 = mysqli_query($GLOBALS["___mysqli_ston"], "select * from gejala where id_gejala='$d7[id_gejala]'") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
                        ...
                        $ssum7 = mysqli_query($GLOBALS["___mysqli_ston"], "select sum(if(a.konsultasi=$konsultasi, a.bobot,0)) as j7
                                                from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P07%')") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
						...
						while($d8 = mysqli_fetch_array($s8)){
							if($r8>0){
								$sg8 = mysqli_query($GLOBALS["___mysqli_ston"], "select * from gejala where id_gejala='$d8[id_gejala]'") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
                        ...
                        $ssum8 = mysqli_query($GLOBALS["___mysqli_ston"], "select sum(if(a.konsultasi=$konsultasi, a.bobot,0)) as j8
                                                from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P08%')") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
						...
						while($d9 = mysqli_fetch_array($s9)){
							if($r9>0){
								$sg9 = mysqli_query($GLOBALS["___mysqli_ston"], "select * from gejala where id_gejala='$d9[id_gejala]'") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
                        ...
                        $ssum9 = mysqli_query($GLOBALS["___mysqli_ston"], "select sum(if(a.konsultasi=$konsultasi, a.bobot,0)) as j9
                                                from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P09%')") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
                        ...
                        if($MAX==$proses1){
                            ...
                            $sp = mysqli_query($GLOBALS["___mysqli_ston"], "select * from penyakit where kode_penyakit LIKE 'P06%'") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
                            $dp = mysqli_fetch_array($sp);
                            $spas =  mysqli_query($GLOBALS["___mysqli_ston"], "select * from user where id_user='$id'") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
                            $dpas = mysqli_fetch_array($spas);
