			...
			<div>
                ...
                <div style="margin-top:10px">
                    <form name="form1" method="post" action="">
                        ...
                        <tr>
                                    <td class='text-left text-error' width='20%'> Pentakit </td>
                                        <td class='text-left text-error' width='40%'> Deskripsi </td>		
                                        <td class='text-left text-error' width='40%'> Solusi </td>		
                                    </tr>
                            <?php 
                                $sg = mysql_query("select * from penyakit");
